...
import argparse
import sys
from tp1.funciones import cambiar_colores_blue, cambiar_colores_green, cambiar_colores_red, espejado
...
if __name__ == '__main__':
    ...
    queuee.put(cuerpo)
    # creo hijos
    h_r = multiprocessing.Process(target=cambiar_colores_red, args=(encabezado, queuered))
    h_g = multiprocessing.Process(target=cambiar_colores_green, args=(encabezado, queuegreen))
    h_b = multiprocessing.Process(target=cambiar_colores_blue, args=(encabezado, queueblue))
